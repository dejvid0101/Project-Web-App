...
namespace Client_Side
{
    ...
    {
        public UserManager(IUserStore<AppUser, int> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new UserManager(new UserStore<AppUser, Role, int, UserLogin, UserRole, UserClaim> (context.Get<RwaIdentityDbContext>()));
    ...
    public class RwaSignInManager : SignInManager<AppUser, int>
    {
        public RwaSignInManager(UserManager userManager, IAuthenticationManager authenticationManager)
        ...
        {
            return new RwaSignInManager(context.GetUserManager<UserManager>(), context.Authentication);
        }
    }
}
