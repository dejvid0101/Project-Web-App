        ...
        <div class="col-lg-6">
            <fieldset class="border p-4">
                ...
                <div class="m-3">
                    ...
                    <asp:Label ID="LabelOwner" runat="server" Text="Owner ID:"></asp:Label>
                    <div class="row">
                        <div class="col-10">
                            <asp:TextBox class="form-control" ID="TextBoxOwner" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-2">
                    ...
                    <div class="row">
                        <div class="col-10">
                            <asp:TextBox class="form-control" ID="TextBoxCity" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-2">
                            <asp:Button runat="server" ID="btnCity" Text="City list" OnClick="btnCity_Click" class="btn btn-primary"></asp:Button>
                        </div>
                    </div>
                    ...
                    <button type="button" class=" mt-3 btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalRUSure">
 Delete
</button>
    ...
    <div class="m-3 ">
        <div class="m-3">
            ...
            <p style="font-size: 2rem; font-weight: bold">Edit status:</p>
        </div>
    ...
    <div class="modal fade" id="modalRUSure" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <asp:LinkButton OnClick="LinkButton2_Click" CommandArgument="<%#Eval(TextBox1.Text) %>" class="btn btn-danger" ID="LinkButton2" runat="server" Text="Delete"></asp:LinkButton>
                </div>
                </div>
            </div>
        </div>
